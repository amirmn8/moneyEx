        ...
        <div class="bg-white dark:bg-black md:bg-slate-100">
            ...
            <div class="dark:bg-black bg-slate-100 dark:text-white">
                <div class="flex flex-col bg-terms items-center justify-center h-full md:py-24 py-12 gap-4">
                    ...
                    <p class="md:w-1/2 w-5/6 text-center">مانی اکس تابع قوانین جمهوری اسلامی ایران بوده و بستری برای تبادل دارایی‌های
                        دیجیتال مانند بیت کوین،
                        لایت کوین و اتریوم با ریال می‌باشد. هیچ گونه تبادل ارزی اعم از خرید و فروش دلار یا سایر ارزهای
                        کاغذی، در این بستر صورت نمی گیرد</p>
                </div>
                <div class="2xl:mx-36  mb-16 mt-16">
                    <div class="flex flex-col gap-4 mx-8 2xl:mx-0">
                        <p class="font-bold text-lg">تعهدنامه فعالیت در بستر تبادل دارایی‌های دیجیتال</p>
                        ...
                        <p class="font-bold text-lg">لغو سفارش در صورت قیمت‌گذاری غیرمتعارف</p>
                        ...
                        <p class="font-bold text-lg">هزینه‌ها و کارمزدها
                        </p>
