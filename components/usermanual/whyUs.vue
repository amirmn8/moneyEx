<template>
    <div class="flex flex-col md:flex-row gap-16 md:gap-10 mt-16 justify-center">
        <div class="border-gray-200 rounded-xl border border-solid flex justify-center relative mx-12 md:mx-0 px-2">
            ...
            <div class="text-center flex flex-col gap-2 leading-6 pb-4">
                <p class=" mt-16 text-md font-bold">مانی اکسـ چیست؟</p>
                <p>مانی اکس چیست؟ چه خدماتی دارد؟ راه‌های ارتباطی با مانی اکس و توضیحات کلی برای شروع فعالیت در ملنی اکس را
