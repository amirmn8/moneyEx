    ...
    <section class="flex items-center justify-center w-full pt-12 sm:py-8 px-4">
        <div style="direction: ltr;" class="w-full relative flex items-center justify-center">
            ...
            <div class="w-full mx-auto overflow-auto no-scrollbar">
                <div id="slider"
                    class=" flex xl:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700">
                    <div v-for="i in 4" class="flex flex-shrink-0 flex-col xl:flex-row-reverse w-full xl:h-530">
                        ...
                        <div
                            ...
                            <p class="text-base xl:leading-10 md:flex w-full text-end h-5/6 overflow-hidden">
                                ...
                                بازارهای مالی، ریسک‌ها و چالش‌های خود را دارد و به همان اندازه که سودهای بالایی را نصیب
                                سرمایه‌گذاران خود می‌کند، ممکن است ضررهای جبران‌ناپذیری را هم به افراد وارد کند
                                بازار رمز ارزها از گذشته تا امروز، گزینه‌ای جذاب برای سرمایه‌گذاران بوده است تا با استفاده
                            ...
                            <button class="flex justify-between">
                                <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="27.176" height="27.176"
                                    ...
                                    <p class="text-ExYellow">ادامه مطلب</p>
                                </div>
